...
set_property PACKAGE_PIN U9 [get_ports {barNumSws[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {barNumSws[0]}]
#Bank = 34, Pin name = IO_25_34,							Sch name = SW1
set_property PACKAGE_PIN U8 [get_ports {barNumSws[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {barNumSws[1]}]
