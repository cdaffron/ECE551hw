...
ExecStep xelab -m64 --debug typical --relax -L xil_defaultlib -L blk_mem_gen_v8_2 -L xbip_utils_v3_0 -L xbip_pipe_v3_0 -L xbip_bram18k_v3_0 -L mult_gen_v12_0 -L c_reg_fd_v12_0 -L xbip_dsp48_wrapper_v3_0 -L xbip_dsp48_addsub_v3_0 -L xbip_addsub_v3_0 -L c_addsub_v12_0 -L axi_utils_v2_0 -L cordic_v6_0 -L unisims_ver -L unimacro_ver -L secureip --snapshot disp_sim_behav --prj /data1/cdaffron/git/ece551hw/final/chris/disp_draw/disp_draw.sim/sim_1/behav/disp_sim.prj   xil_defaultlib.disp_sim   xil_defaultlib.glbl
