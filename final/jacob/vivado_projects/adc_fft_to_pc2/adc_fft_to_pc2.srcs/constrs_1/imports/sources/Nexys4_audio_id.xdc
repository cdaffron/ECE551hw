...
set_property PACKAGE_PIN F14 [get_ports cs]
...
set_property MARK_DEBUG true [get_nets event_data_in_channel_halt]
set_property MARK_DEBUG true [get_nets event_data_out_channel_halt]
set_property MARK_DEBUG true [get_nets event_frame_started]
set_property MARK_DEBUG true [get_nets event_status_channel_halt]
set_property MARK_DEBUG true [get_nets event_tlast_missing]
set_property MARK_DEBUG true [get_nets event_tlast_unexpected]
set_property MARK_DEBUG true [get_nets m_axis_data_tlast]
set_property MARK_DEBUG true [get_nets m_axis_data_tready]
set_property MARK_DEBUG true [get_nets m_axis_data_tvalid]
set_property MARK_DEBUG true [get_nets ram_initialized]
set_property MARK_DEBUG true [get_nets rst]
set_property MARK_DEBUG true [get_nets run]
...
set_property MARK_DEBUG true [get_nets txfinished]
set_property MARK_DEBUG true [get_nets txready]
set_property MARK_DEBUG true [get_nets {fft_points[0]}]
set_property MARK_DEBUG true [get_nets {fft_points[1]}]
set_property MARK_DEBUG true [get_nets {fft_points[2]}]
set_property MARK_DEBUG true [get_nets {fft_points[3]}]
set_property MARK_DEBUG true [get_nets {fft_points[4]}]
set_property MARK_DEBUG true [get_nets {rxbyte[0]}]
set_property MARK_DEBUG true [get_nets {rxbyte[1]}]
set_property MARK_DEBUG true [get_nets {rxbyte[2]}]
set_property MARK_DEBUG true [get_nets {rxbyte[3]}]
set_property MARK_DEBUG true [get_nets {rxbyte[4]}]
set_property MARK_DEBUG true [get_nets {rxbyte[5]}]
set_property MARK_DEBUG true [get_nets {rxbyte[6]}]
set_property MARK_DEBUG true [get_nets {rxbyte[7]}]
set_property MARK_DEBUG true [get_nets {s_axis_config_tdata[0]}]
set_property MARK_DEBUG true [get_nets {s_axis_config_tdata[8]}]
set_property MARK_DEBUG true [get_nets {s_axis_config_tdata[1]}]
set_property MARK_DEBUG true [get_nets {s_axis_config_tdata[2]}]
set_property MARK_DEBUG true [get_nets fft_rst]
set_property MARK_DEBUG true [get_nets {s_axis_config_tdata[4]}]
set_property MARK_DEBUG true [get_nets {s_axis_config_tdata[3]}]
...
set_property MARK_DEBUG true [get_nets {uart_data[31]}]
set_property MARK_DEBUG true [get_nets {uart_data[30]}]
set_property MARK_DEBUG true [get_nets {uart_data[29]}]
set_property MARK_DEBUG true [get_nets {uart_data[28]}]
set_property MARK_DEBUG true [get_nets {uart_data[27]}]
set_property MARK_DEBUG true [get_nets {uart_data[26]}]
set_property MARK_DEBUG true [get_nets {uart_data[25]}]
set_property MARK_DEBUG true [get_nets {uart_data[24]}]
set_property MARK_DEBUG true [get_nets {uart_data[23]}]
set_property MARK_DEBUG true [get_nets {uart_data[22]}]
set_property MARK_DEBUG true [get_nets {uart_data[21]}]
set_property MARK_DEBUG true [get_nets {uart_data[20]}]
set_property MARK_DEBUG true [get_nets {uart_data[19]}]
set_property MARK_DEBUG true [get_nets {uart_data[18]}]
set_property MARK_DEBUG true [get_nets {uart_data[17]}]
...
set_property MARK_DEBUG true [get_nets {uart_data[8]}]
set_property MARK_DEBUG true [get_nets {uart_data[9]}]
set_property MARK_DEBUG true [get_nets {uart_data[10]}]
set_property MARK_DEBUG true [get_nets {uart_data[11]}]
set_property MARK_DEBUG true [get_nets {uart_data[12]}]
set_property MARK_DEBUG true [get_nets {uart_data[13]}]
set_property MARK_DEBUG true [get_nets {uart_data[14]}]
set_property MARK_DEBUG true [get_nets {uart_data[15]}]
set_property MARK_DEBUG true [get_nets {uart_data[16]}]
set_property MARK_DEBUG true [get_nets txready]
create_debug_core u_ila_0 ila
set_property ALL_PROBE_SAME_MU true [get_debug_cores u_ila_0]
set_property ALL_PROBE_SAME_MU_CNT 1 [get_debug_cores u_ila_0]
